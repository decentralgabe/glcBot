@REM glcbot launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM GLCBOT_config.txt found in the GLCBOT_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%GLCBOT_HOME%"=="" set "GLCBOT_HOME=%~dp0\\.."

set "APP_LIB_DIR=%GLCBOT_HOME%\lib\"
...
set "CFG_FILE=%GLCBOT_HOME%\GLCBOT_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running glcbot.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !GLCBOT_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
